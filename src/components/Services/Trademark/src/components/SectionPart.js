  ...
  return (
    <>
        <section className="main-content">
            <div className="left" id="lefty">
                <div id="activeTableContentaa">
                    ...
                    <p> <a className="tabanchor" href="#content1">what can you Register? </a></p>
                    <p> <a className="tabanchor" href="#laws" >Why Tradmark </a></p>
                    <p> <a className="tabanchor" href="#eligibility" >Tradenark classes</a></p>
                    <p> <a className="tabanchor" href="#attachment">How to Register </a>
                    </p>
                    <p> <a className="tabanchor" href="#checklist" >Tradmark Objection </a>
                    </p>


                    <p> <a className="tabanchor" href="#opposition" >Tradmark Opposition</a></p>
                    <p> <a className="tabanchor" href="#document" >Document Required</a></p>
                    <p> <a className="tabanchor" href="#faq" >FAQs</a></p>
                    <br/>
                </div>
                <button type="submit" id="contact" ><a href="#contactus"><b> CONTACT US </b></a></button>
            </div>
             <br/><br/>
            <div className="right1" id="necessity overview">
            ...
            <div id="content1">
               <br/><br/><br/>            
                ...
                <div className="ICI necessity" id="eligibility">
                    <h1 id="eligibility"> Trademark classNamees</h1>
                    <br/>

                    <p>here are 45 trademark classNamees and all the goods and services are categorised across these
                        ...
                        different goods/services that fall under different classNamees, you have to ensure that you apply
                        for the trademark under all the applicable classes.
                    </p>
                    <br/>
                    <p>Some of the popular trademark classNamees in India are:</p>
                    <br/>
                    <ul>
                        ...
                        <p>If you are operating within these trademark classNamees, the competition for a trademark might be
                ...
                <div className="ICI necessity">
                    ...
                    <h3>
                        Step 2: className Selection and Document Collection</h3><br/>
                    <p>
                        The next task is to select the appropriate className(es) for your business. You need not worry too
                        much though. Our experts will guide you in selecting the right classNamees to cover all aspects of
        ...
        <div className="accordion" id="faq">
            <FRQ number={0} ques="What is a trademark class?"
                answer="The Trademark Registry has classified goods and services under 45 classes. Each class lists a host of goods/services and depending on those you are offering, you need to mention the class(es) on your trademark application. 
                The trademark would be registered and protected under those classes only." />

            <FRQ number={1} ques="What trademark applications are commonly rejected?"
                answer="If your trademark is similar to an existing application, would hurt religious sentiments, contains geographical names, or common words. 
                It would also be rejected if it is likely to confuse."/>
            <FRQ number={2} ques="When can I use the TM symbol?" 
                answer="file the application and receive an acknowledgement, you can use the ™ symbol. Once the registration process is complete, you can use the ® symbol." />
            <FRQ number={3} ques="How can I run a trademark search?"
                answer="You can run a simple trademark search easily by clicking here. 
                However, if you are serious about getting your trademark registered, 
                it is advised to get a professional to do thorough trademark research." />
            <FRQ number={4} ques="What if my trademark is taken, but under a different class?"
                answer= "If your brand name has already been registered, but under a different class, you're still in luck. Unless the brand is too well known (like McDonald’s or Fiat), your application is likely to be approved."/>
            <FRQ number={5} ques="What if someone has a similar word trademarker?"
                answer="You can't get the word, but all is not lost. You could instead design a unique logo for your." />
            <FRQ number={6} ques=" Do you guarantee approval of my trademark?"
                answer="It depends entirely on the government's judgement. But if it is unique, it is highly likely that it will be granted." />
            <FRQ number={7} ques="Should I file the trademark in my own name?"
                answer="Many start-up founders register it in their own names, 
                while large businesses would prefer to do so in the name of the company. This is because the future of a start-up is always in doubt. If owned by the founder, the trademark would be valid regardless of the state of the company. 
                A trademark license agreement is, however, needed in this case." />
            <FRQ number={8} ques="How long does it take to get my trademark?"
                 answer="It can take anywhere between 6 months to 1 year for your trademark to be approved. However, we can apply and start using the ™ symbol within few days if we can get all the details and documents at the earliest."/>
            <FRQ number={9} ques="Still Confuse?"
